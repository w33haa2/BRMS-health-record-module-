...
<meta http-equiv="expires" content="0">
	...
	<script src="{{ asset('/temp/assets/js/jquery-1.11.3.min.js') }}"></script>
...
<body>
				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="{{ ('temp/assets/images/thumb-1@2x.png') }}" alt="" class="img-circle" width="44" />
							John Henderson
						</a>
							...
							<li>
								...
								<ul class="dropdown-menu-list scroller">
									<li class="active">
										<a href="#">
											<span class="image pull-right">
												<img src="{{ asset('/temp/assets/images/thumb-1@2x.png') }}" width="44" alt="" class="img-circle" />
											</span>
									...
									<li class="active">
										<a href="#">
											<span class="image pull-right">
												<img src="{{ asset('/temp/assets/images/thumb-2@2x.png') }}" width="44" alt="" class="img-circle" />
											</span>
									...
									<li>
										<a href="#">
											<span class="image pull-right">
												<img src="{{ asset('/temp/assets/images/thumb-3@2x.png') }}" width="44" alt="" class="img-circle" />
											</span>
									...
									<li>
										<a href="#">
											<span class="image pull-right">
												<img src="{{ asset('/temp/assets/images/thumb-4@2x.png') }}" width="44" alt="" class="img-circle" />
											</span>
				...
				<ul class="list-inline links-list pull-right">
					...
					<li class="dropdown language-selector">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
							<img src="{{ asset('/temp/assets/images/flags/flag-uk.png') }}" width="16" height="16" />
						</a>
		
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="#">
									<img src="{{ asset('/temp/assets/images/flags/flag-de.png') }}" width="16" height="16" />
									<span>Deutsch</span>
								</a>
							</li>
							<li class="active">
							...
							<li>
								<a href="#">
									<img src="{{ asset('/temp/assets/images/flags/flag-fr.png') }}" width="16" height="16" />
									<span>François</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{ asset('/temp/assets/images/flags/flag-al.png') }}" width="16" height="16" />
									<span>Shqip</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{ asset('/temp/assets/images/flags/flag-es.png') }}" width="16" height="16" />
									<span>Español</span>
								</a>
							</li>
						</ul>
					...
					<li>
						 ...
						 <a href="{{ route('logout') }}"
                                            ...
                                            Logout
                                        </a><i class="entypo-logout right"></i>
	...
	<link rel="stylesheet" href="{{ asset('/temp/assets/js/jvectormap/jquery-jvectormap-1.2.2.css') }}">
	<link rel="stylesheet" href="{{ asset('/temp/assets/js/rickshaw/rickshaw.min.css') }}">
	...
	<script src="{{ asset('/temp/assets/js/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>


	<!-- Imported scripts on this page -->
	<script src="{{ asset('/temp/assets/js/jvectormap/jquery-jvectormap-europe-merc-en.js') }}"></script>
	<script src="{{ asset('/temp/assets/js/jquery.sparkline.min.js') }}"></script>
	<script src="{{ asset('/temp/assets/js/rickshaw/vendor/d3.v3.js') }}"></script>
	<script src="{{ asset('/temp/assets/js/rickshaw/rickshaw.min.js') }}"></script>
	<script src="{{ asset('/temp/assets/js/raphael-min.js') }}"></script>
	<script src="{{ asset('/temp/assets/js/morris.min.js') }}"></script>
	<script src="{{ asset('/temp/assets/js/toastr.js') }}"></script>
	<script src="{{ asset('/temp/assets/js/neon-chat.js') }}"></script>
